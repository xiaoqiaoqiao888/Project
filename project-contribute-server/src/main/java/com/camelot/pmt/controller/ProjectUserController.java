...
public class ProjectUserController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", name = "projectId", dataType = "int", value = "项目id", required = true),
            @ApiImplicitParam(paramType = "query", name = "realName", dataType = "string", value = "真实姓名，模糊查询", required = false),
            @ApiImplicitParam(paramType = "query", name = "groupId", dataType = "int", value = "职能组id", required = false),
            @ApiImplicitParam(paramType = "query", name = "page", dataType = "int", value = "页码", required = false),
            @ApiImplicitParam(paramType = "query", name = "size", dataType = "int", value = "每页显示条数", required = false) })
