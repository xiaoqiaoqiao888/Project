...
public class SysGroupController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "用户ID", paramType = "query", dataType = "int"),
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "groupId", value = "部门组id", paramType = "query", dataType = "int"),
