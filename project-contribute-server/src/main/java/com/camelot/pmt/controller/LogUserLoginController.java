...
public class LogUserLoginController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "pageNum", value = "页码", paramType = "query", dataType = "int"),
            ...
            @ApiImplicitParam(name = "id", value = "登录用户id", paramType = "query", dataType = "Integer"),
            @ApiImplicitParam(name = "loginUser", value = "登录用户名称", paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "loginTime", value = "登录时间", paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "loginIp", value = "登录IP", paramType = "query", dataType = "Integer") })
    public ResponseEntity<PageInfo<?>> queryList(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "ids", value = "登录用户ids", required = true, paramType = "query", dataType = "Integer") })
