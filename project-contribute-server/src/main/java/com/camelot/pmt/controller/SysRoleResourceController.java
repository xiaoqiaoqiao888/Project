...
public class SysRoleResourceController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "pageNum", value = "页码", paramType = "query", dataType = "int"),
            ...
            @ApiImplicitParam(name = "id", value = "资源(菜单)权限Id", paramType = "query", dataType = "Integer"),
            @ApiImplicitParam(name = "resourceId", value = "资源Id", paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "roleIds", value = "角色Ids", required = true, paramType = "query", dataType = "Integer") })
    public ResponseEntity<?> queryDTOList(@RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
            @RequestParam(value = "pageSize", defaultValue = "10") Integer pageSize,
            @ApiIgnore SysRoleResource sysRoleResource, Long[] roleIds) {
        ...
        return ResponseEntity
                .ok(sysRoleResourceService.querySysRoleResourceDTOList(pageNum, pageSize, sysRoleResource, roleIds));
    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "resourceIds", value = "资源ids", paramType = "query", dataType = "Long"),
