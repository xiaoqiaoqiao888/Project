...
public class WorkController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "workName", value = "工程包名称",
                    required = false, paramType = "query", dataType = "String"),
            @ApiImplicitParam(name = "workBudget", value = "工程包预算",
                    required = false, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "workValue", value = "价值分",
                    required = false, paramType = "query", dataType = "String"),
            @ApiImplicitParam(name = "startTime", value = " 工程包预计开始时间",
                    required = false, paramType = "query", dataType = "date"),
            @ApiImplicitParam(name = "endTime", value = "工程包预计结束时间",
                    required = false, paramType = "query", dataType = "date"),
            @ApiImplicitParam(name = "workState", value = "工程包业务状态自定",
                    required = false, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "workType", value = "工程包类型",
                    required = false, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "state", value = "状态值 0-无效 1-有效",
                    required = false, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "workDesc", value = "工程包描述",
                    required = false, paramType = "query", dataType = "String"),})
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "工程包ID",
                    required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "projectId", value = "项目ID",
                    required = true, paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "stageId", value = "阶段ID",
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "workCostStatus", value = "是否超预算（1:未超预算;0:超预算）", paramType = "query",
                    dataType = "int")
            })
    public ResponseEntity<PageInfo<WorkDTO>> getWorkCostListByPage(
            @RequestParam(value = "pageNum",defaultValue = "1") Integer pageNum,
            @RequestParam(value = "pageSize",defaultValue = "10") Integer pageSize,
            @ApiIgnore WorkDTO workDTO) {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "stageId", value = "阶段id", paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "workState", value = "项目状态(0:未开始;1:进行中;2:待验收;3:已完成;4:延期进行中)",
                    paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "costStatus", value = "是否超预算（1:未超预算;0:超预算）", paramType = "query",
                    dataType = "int")
            })
    ...
    @ApiOperation(value = "根据id查询工程包信息", notes = "根据id查询工程包信息")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "工程包id", paramType = "query", dataType = "int")
            })
