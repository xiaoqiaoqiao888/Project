...
public class SysUserRoleController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleId", value = "角色ID", required = true, paramType = "form", dataType =
                    "int"),
            @ApiImplicitParam(name = "userIds", value = "用户ID集合如 1,2,3", required = true, paramType = "form",
                    dataType = "int")})
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "userId", value = "用户ID", required = true, paramType = "query",
                    dataType = "int"),
            @ApiImplicitParam(name = "roleIds", value = "角色ID集合如 1,2,3", paramType = "query",
                    dataType = "int")})
